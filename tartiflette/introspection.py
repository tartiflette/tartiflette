...
class __InputValueResolvers:
    ...
    @staticmethod
    async def default_value_resolver(
        parent, _arguments, _request_ctx, _info: Info
    ):
        try:
...
class __TypeResolvers:
    ...
    @staticmethod
    async def possible_types_resolver(
        parent, _arguments, _request_ctx, info: Info
    ):
        try:
...
__Type = GraphQLObjectType(
    ...
    fields=OrderedDict(
        [
            ...
            (
                "ofType",
                GraphQLField(name="ofType", gql_type="__Type", resolver=None),
            ),
        ]
    ),
)
...
class __SchemaResolvers:
    ...
    @staticmethod
    async def query_type_resolver(
        _parent, _arguments, _request_ctx, info: Info
    ):
        return info.schema.types[info.schema.query_type]

    @staticmethod
    async def mutation_type_resolver(
        _parent, _arguments, _request_ctx, info: Info
    ):
        return info.schema.types[info.schema.mutation_type]

    @staticmethod
    async def subscription_type_resolver(
        _parent, _arguments, _request_ctx, info: Info
    ):
        return info.schema.types[info.schema.subscription_type]
