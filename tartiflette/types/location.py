...
class Location:
    ...
    def __init__(self, line: int, column: int, line_end: Optional[int] = None,
                 column_end: Optional[int] = None, context: str = ""):
        self.line = line
        self.column = column
