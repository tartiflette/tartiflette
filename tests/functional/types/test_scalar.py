...
@pytest.mark.parametrize("input_sdl,resolver_response,expected", [
    ...
    (
        "[Date!]",
        datetime(year=2017, month=3, day=18, hour=13, minute=56, second=37),
        '{"data":{"testField":null},"errors":[{"message":"Invalid value (value: datetime.datetime(2017, 3, 18, 13, 56, 37)) for field `testField` of type `[Date!]`","path":["testField"],"locations":[{"line":1,"column":26}]}]}',
    ),
])
