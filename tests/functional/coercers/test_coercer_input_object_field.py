...
@pytest.mark.ttftt_engine(
    name="coercion",
    resolvers={"Query.inputObjectField": resolve_input_object_field},
)
@pytest.mark.parametrize(
    "query,variables,expected",
    [
        (
            """query { inputObjectField }""",
            None,
            {"data": {"inputObjectField": "SUCCESS"}},
        ),
        (
            """query { inputObjectField(param: null) }""",
            None,
            {"data": {"inputObjectField": "SUCCESS-None"}},
        ),
        (
            """query { inputObjectField(param: {}) }""",
            None,
            {"data": {"inputObjectField": "SUCCESS-{}"}},
        ),
        (
        ...
        (
            """query ($param: MyInput = null) { inputObjectField(param: $param) }""",
            None,
            {"data": {"inputObjectField": "SUCCESS-None"}},
        ),
        (
...
async def test_coercer_input_object_field(engine, query, variables, expected):
