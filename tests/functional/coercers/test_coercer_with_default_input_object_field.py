...
@pytest.mark.ttftt_engine(
    name="coercion",
    resolvers={
        "Query.withDefaultInputObjectField": resolve_input_object_field
    },
)
@pytest.mark.parametrize(
    ...
    [
        (
            """query { withDefaultInputObjectField }""",
            None,
            {"data": {"withDefaultInputObjectField": "SUCCESS"}},
        ),
        (
            """query { withDefaultInputObjectField(param: null) }""",
            None,
            {"data": {"withDefaultInputObjectField": "SUCCESS-None"}},
        ),
        (
            """query { withDefaultInputObjectField(param: {}) }""",
            None,
            {
                "data": {
                    "withDefaultInputObjectField": "SUCCESS-"
                    "[booleanField:True]-"
        ...
        (
            """
            query {
              withDefaultInputObjectField(param: {
                booleanField: null
                enumField: null
                floatField: null
                intField: null
        ...
        (
            """query ($param: MyInputWithDefault) { withDefaultInputObjectField(param: $param) }""",
            None,
            {"data": {"withDefaultInputObjectField": "SUCCESS"}},
        ),
        (
        ...
        (
            """query ($param: MyInputWithDefault = null) { withDefaultInputObjectField(param: $param) }""",
            None,
            {"data": {"withDefaultInputObjectField": "SUCCESS-None"}},
        ),
        (
        ...
        (
            """query (
              ...
              withDefaultInputObjectField(param: $param)
            }""",
            None,
            {
                "data": {
...
async def test_coercer_with_default_input_object_field(
