...
@pytest.mark.ttftt_engine(
    name="coercion",
    resolvers={
        "Query.inputObjectWithDefaultField": resolve_input_object_field
    },
)
@pytest.mark.parametrize(
    ...
    [
        (
            """query { inputObjectWithDefaultField }""",
            None,
            {
                "data": {
                    "inputObjectWithDefaultField": "SUCCESS-"
                    "[booleanField:True]-"
        ...
        (
            """query { inputObjectWithDefaultField(param: null) }""",
            None,
            {"data": {"inputObjectWithDefaultField": "SUCCESS-None"}},
        ),
        (
            """query { inputObjectWithDefaultField(param: {}) }""",
            None,
            {"data": {"inputObjectWithDefaultField": "SUCCESS-{}"}},
        ),
        (
            """
            query {
              inputObjectWithDefaultField(param: {
                booleanField: null
                enumField: null
                floatField: null
                intField: null
        ...
        (
            """query ($param: MyInput) { inputObjectWithDefaultField(param: $param) }""",
            None,
            {
                "data": {
                    "inputObjectWithDefaultField": "SUCCESS-"
        ...
        (
            """query ($param: MyInput = null) { inputObjectWithDefaultField(param: $param) }""",
            None,
            {"data": {"inputObjectWithDefaultField": "SUCCESS-None"}},
        ),
        (
        ...
        (
            """query (
              ...
              inputObjectWithDefaultField(param: $param)
            }""",
            None,
            {
                "data": {
...
async def test_coercer_input_object_with_default_field(
