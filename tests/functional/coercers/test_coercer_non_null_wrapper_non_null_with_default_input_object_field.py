    ...
    [
        (
            ...
            None,
            {
                ...
                "errors": [
                    {
                        "message": "Field < nonNullWrapperNonNullWithDefaultInputObjectField > argument < param > of type < WrapperNonNullWithDefaultMyInput! > is required, but it was not provided.",
                        "path": None,
