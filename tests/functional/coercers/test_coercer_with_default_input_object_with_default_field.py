...
@pytest.mark.ttftt_engine(
    name="coercion",
    resolvers={
        "Query.withDefaultInputObjectWithDefaultField": resolve_input_object_field
    },
)
@pytest.mark.parametrize(
    ...
    [
        (
            """query { withDefaultInputObjectWithDefaultField }""",
            None,
            {
                "data": {
                    "withDefaultInputObjectWithDefaultField": "SUCCESS-"
                    "[booleanField:True]-"
        ...
        (
            """query { withDefaultInputObjectWithDefaultField(param: null) }""",
            None,
            {
                "data": {
                    "withDefaultInputObjectWithDefaultField": "SUCCESS-None"
                }
            },
        ),
        (
            """query { withDefaultInputObjectWithDefaultField(param: {}) }""",
            None,
            {
                "data": {
                    "withDefaultInputObjectWithDefaultField": "SUCCESS-"
        ...
        (
            """
            query {
              withDefaultInputObjectWithDefaultField(param: {
                booleanField: null
                enumField: null
                floatField: null
                intField: null
        ...
        (
            """query ($param: MyInputWithDefault) { withDefaultInputObjectWithDefaultField(param: $param) }""",
            None,
            {
                "data": {
                    "withDefaultInputObjectWithDefaultField": "SUCCESS-"
        ...
        (
            """query ($param: MyInputWithDefault = null) { withDefaultInputObjectWithDefaultField(param: $param) }""",
            None,
            {
                "data": {
                    "withDefaultInputObjectWithDefaultField": "SUCCESS-None"
        ...
        (
            """query (
              ...
              withDefaultInputObjectWithDefaultField(param: $param)
            }""",
            None,
            {
                "data": {
...
async def test_coercer_with_default_input_object_with_default_field(
